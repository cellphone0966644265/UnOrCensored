...
def main():
    parser = argparse.ArgumentParser(description="Huấn luyện model BiSeNet để thêm mosaic")
    ...
    print("--- Bắt đầu huấn luyện 'add_youknow' ---")
    ...
    model_save_path = dir_checkpoint / "add_youknow.pth"
    torch.save(net.state_dict(), model_save_path)
    arch_info = {'architecture': 'BiSeNet', 'params': {'num_classes': 1, 'context_path': 'resnet18'}}
    yaml_save_path = dir_checkpoint / "add_youknow_structure.yaml"
